...
import com.svenruppert.flow.views.publications.ClientsView;
...
@DisplayName("ClientsView — client master data (Auftraggeber)")
class ClientsViewBrowserlessTest extends BrowserlessTest {
  ...
  void setUp() {
    ...
    repo.createClient("ACME Publishing");
  ...
  void listsClients() {
    ...
    assertTrue($view(Button.class).all().stream()
        .map(Button::getText).collect(Collectors.toList()).contains("+ Client"));
  }
}
